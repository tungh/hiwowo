...
object TopicDao {
 ...
 /* 增加一个话题 */
  ...
  def search(typeId:Int,text:String, currentPage: Int = 1, pageSize: Int = 10)  = database.withDynSession {
  ...
  def filterTopics(name:Option[String],checkState:Option[Int],typeId:Option[Int],isBest:Option[Boolean],isTop:Option[Boolean],currentPage:Int,pageSize:Int) = database.withDynSession {
